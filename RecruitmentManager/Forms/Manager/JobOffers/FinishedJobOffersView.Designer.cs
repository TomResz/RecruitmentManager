namespace RecruitmentManager.Forms.Manager.JobOffers
{
	partial class FinishedJobOffersView
	{
		...
		private void InitializeComponent()
		{
			...
			jobOffersDGV.Size = new Size(1051, 359);
			...
			mainLayout.Size = new Size(1057, 419);
			...
			footerLayout.Location = new Point(3, 365);
			...
			footerLayout.Size = new Size(1051, 52);
			...
			pageCounterLabel.Location = new Point(993, 18);
			...
			nextPageButton.Location = new Point(936, 2);
			...
			previousPageButton.Location = new Point(879, 2);
