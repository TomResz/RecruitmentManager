namespace RecruitmentManager.Forms.Manager.JobOffers
{
	partial class AddJobOfferForm
	{
		...
		private void InitializeComponent()
		{
			...
			tabControl.Size = new Size(1289, 650);
			...
			description_work.Size = new Size(1281, 606);
			...
			mainLayout.Size = new Size(1275, 600);
			...
			middleLayout.Size = new Size(1275, 515);
			...
			headerLayout.Size = new Size(1275, 92);
			...
			titleTextBox.Size = new Size(1184, 86);
			...
			descriptionLayout.Location = new Point(0, 92);
			...
			descriptionLayout.Size = new Size(1275, 423);
			...
			descriptionTextBox.Size = new Size(1184, 417);
			...
			footerTableLayout.Controls.Add(saveBtn, 6, 0);
			footerTableLayout.Dock = DockStyle.Fill;
			footerTableLayout.Location = new Point(0, 515);
			...
			footerTableLayout.Size = new Size(1275, 85);
			...
			endDatePB.Location = new Point(396, 0);
			...
			beginDateDatePicker.Size = new Size(305, 27);
			...
			endDateDatePicker.Location = new Point(484, 29);
			endDateDatePicker.Name = "endDateDatePicker";
			endDateDatePicker.Size = new Size(305, 27);
			...
			numberOfPlacesPB.Location = new Point(792, 0);
			...
			counterControl.Location = new Point(880, 23);
			...
			saveBtn.Font = new Font("Times New Roman", 16.2F, FontStyle.Bold, GraphicsUnit.Point);
			saveBtn.Location = new Point(965, 3);
			saveBtn.Name = "saveBtn";
			saveBtn.Size = new Size(307, 79);
			saveBtn.TabIndex = 6;
			saveBtn.Text = "Zapisz";
			...
			secondPageTableLayout.Size = new Size(1275, 600);
			...
			recruiterDGV.Location = new Point(768, 3);
			...
			recruiterDGV.Size = new Size(504, 594);
			recruiterDGV.TabIndex = 1;
			recruiterDGV.CellContentClick += recruiterDGV_CellContentClick;
			// 
			// Id
			// 
			...
			secondPageLeftLayout.Size = new Size(759, 594);
			...
			recruitmentStagesDGV.Size = new Size(753, 350);
			...
			secondPageControlsLayout.Location = new Point(0, 356);
			...
			secondPageControlsLayout.Size = new Size(759, 238);
			...
			secondPageDesciptionLayout.Size = new Size(753, 78);
			...
			stageNamePB.Size = new Size(79, 72);
			...
			stageNameTitle.Size = new Size(662, 72);
			...
			secondPageCountersLayout.Location = new Point(3, 87);
			...
			secondPageCountersLayout.Size = new Size(753, 78);
			...
			stageOrderPB.Size = new Size(79, 72);
			...
			weightPB.Location = new Point(379, 3);
			weightPB.Name = "weightPB";
			weightPB.Size = new Size(79, 72);
			weightPB.TabIndex = 1;
			...
			orderUpAndDown.Location = new Point(88, 19);
			...
			orderUpAndDown.Size = new Size(285, 39);
			...
			weightUpAndDown.Location = new Point(464, 19);
			...
			weightUpAndDown.Size = new Size(286, 39);
			...
			secondPageButtonsLayout.Location = new Point(3, 171);
			...
			secondPageButtonsLayout.Size = new Size(753, 64);
			...
			addRecruitmentStageBtn.Location = new Point(505, 3);
			addRecruitmentStageBtn.Name = "addRecruitmentStageBtn";
			addRecruitmentStageBtn.Size = new Size(245, 58);
			...
			addRecruitmentStageBtn.Click += addRecruitmentStageBtn_Click;
			// 
			// toolTip
			// 
			...
			ClientSize = new Size(1289, 650);
			Controls.Add(tabControl);
			Name = "AddJobOfferForm";
