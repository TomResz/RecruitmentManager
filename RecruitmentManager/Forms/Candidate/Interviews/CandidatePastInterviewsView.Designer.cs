...
{
	partial class CandidatePastInterviewsView
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			stagesDgv.Size = new Size(1094, 527);
			...
			// 
			// CandidatePastInterviewsView
			// 
			AutoScaleDimensions = new SizeF(8F, 20F);
			AutoScaleMode = AutoScaleMode.Font;
			Controls.Add(stagesDgv);
			Name = "CandidatePastInterviewsView";
			Size = new Size(1094, 527);
