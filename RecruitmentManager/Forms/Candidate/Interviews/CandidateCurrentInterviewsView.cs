...
public partial class CandidateCurrentInterviewsView : UserControl
{
	private readonly IMediator _mediator;
	public CandidateCurrentInterviewsView(IMediator mediator)
	{
		_mediator = mediator;
		InitializeComponent();
	...
	{
		var query = new GetCandidateInterviewsQuery(CandidateInterviewPredicate.Current);
