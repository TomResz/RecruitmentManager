namespace RecruitmentManager.Forms.Recruiter.Stages
{
	partial class StagesMainView
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(StagesMainView));
			mainLayout = new TableLayoutPanel();
			headerLayout = new TableLayoutPanel();
			pastBtn = new Button();
			futureBtn = new Button();
			...
			headerLayout.Controls.Add(futureBtn, 0, 0);
			...
			// futureBtn
			// 
			futureBtn.Dock = DockStyle.Fill;
			futureBtn.FlatStyle = FlatStyle.Flat;
			...
			futureBtn.UseVisualStyleBackColor = true;
			futureBtn.Click += futureBtn_Click;
			// 
			// currentBtn
			// 
