...
namespace RecruitmentManager.Infrastructure.Migrations
{
    ...
    [Migration("20231215194805_jobpostingchange")]
    partial class jobpostingchange
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecruitmentManager.Domain.Entities.CandidateRating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RecruitmentManager.Domain.Entities.JobPosting", b =>
                {
                    ...
                    b.Property<bool>("IsCandidatesSelected")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("RecruitmentManager.Domain.Entities.CandidateRating", b =>
                {
                    b.HasOne("RecruitmentManager.Domain.Entities.Candidate", "Candidate")
                        .WithMany("CandidateRatings")
                        .HasForeignKey("CandidateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RecruitmentManager.Domain.Entities.RecruitmentStage", "RecruitmentStage")
                        .WithMany("CandidateRatings")
