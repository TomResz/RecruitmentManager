...
namespace RecruitmentManager.Infrastructure.Migrations
{
    ...
    [Migration("20231027050714_AddedCandidateDataNullableColumns")]
    partial class AddedCandidateDataNullableColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecruitmentManager.Domain.Entities.Experience", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RecruitmentManager.Domain.Entities.CandidateData", b =>
                {
                    b.HasOne("RecruitmentManager.Domain.Entities.Candidate", "Candidate")
                        ...
                        .HasForeignKey("RecruitmentManager.Domain.Entities.CandidateData", "CandidateId")
            ...
            modelBuilder.Entity("RecruitmentManager.Domain.Entities.KnowledgeOfLanguage", b =>
                {
                    ...
                    b.HasOne("RecruitmentManager.Domain.Entities.LanguageProficiencyLevel", "LanguageProficiencyLevel")
                        .WithMany("KnowledgeOfLanguages")
